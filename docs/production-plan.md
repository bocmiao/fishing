...
| **M2 一天循环** 🟡 | ✅ 饵料变成消耗品、库存和钱、自动存档（v1，带迁移）、手绘地图和赶路、睡觉和一天小结、新手引导（小满的便条）；⏳ 老宅院子和集市的场景插画、接入 Electron | 能连续玩一周游戏日不出问题 | P1：场景插画、NPC 2~3 个 |
| **M3 菜地与饵料** ✅ | 菜地 6 块、5 种作物、开荒翻地挖蚯蚓、石磨磨面、和面饵、点豆腐、堆肥（画面是代码画的占位） | 饵料不用再买也够用；种地和钓鱼互相喂得上 | BG-020 菜地地面、PROP-010 作物 |
| **M4 喵记小馆** ✅ | 活鱼缸、9 道菜、定菜单、傍晚亲手经营、做菜小游戏、口碑、小满代班、杂货铺和鱼摊（画面是代码画的占位） | 开一次店想再开一次；小鱼也有用处 | SCENE-003 小馆插画、NPC-C01~04 客人 |
