...
模拟一个"普通玩家"：每天钓 8 条鱼（鱼竿好了多钓几条，受鱼护限制），种地，傍晚开店，做菜成绩 0.75，有钱就按顺序添置。12 局平均：

| | 第 1 天 | 第 7 天 | 第 14 天 | 第 28 天 | 第 40 天 |
|---|---|---|---|---|---|
| 一天收入 | ¥300 | ¥250 | ¥340 | ¥340 | ¥400 |

- 第 1 天就买得起大号鱼护；**头两周**每 1~3 天添置一样（鱼缸、菜牌、鱼线、开荒、蚯蚓床、碳素竿、清塘、招牌）。
- **第 3~5 周**买大件：桌子、灶台、双层鱼护、整片菜地、大物线、扩塘。
- **老韩手作竿**大约第 37 天，是第一年的一个小目标。
- 40 天后口碑大约 130（口碑 3 周叔来、10 村长来、25 美食博主来）。

**以后的大件（等内容做出来再加）**：修小路解锁荷花湖（约 ¥3000）、修渡船解锁大河（约 ¥6000）、
锦鲤池和苗池（M5 育种）、小馆装修的外观（纯装饰）。新钓点的鱼更值钱，是中后期收入再上一个台阶的地方。
