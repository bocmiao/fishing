...
> 下午在钓位上打个盹 → 18:00 回家，把锦鲤放进池子，起名"小红" →
...
种田建议放在方案 C 之后做：阿喵走到田块上锄地、插秧、浇水、收割，体验最自然。如果想在 C 之前先上，也可以做成点击式（在荒地画面里点田块操作）。技术上复用现有系统：作物和鱼共用"生长系统"，种子、作物、菜肴都是物品，时间和季节现成。
...
| 内容太多做不完 | 严格按里程碑推进；先 B 后 C，种田放在 C 之后 |
