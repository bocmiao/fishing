...
- 左上角"小满的便条"：新手引导，一步一步带你过第一天（可以收起、关掉，关掉后在笔记的"玩法"页重新打开）
- J 或右上角"笔记"：外公笔记，鱼类图鉴（每种鱼一页）、菜谱、36 个成就，还有"玩法"说明
- U 或右上角"添置"：花钱升级——老韩渔具铺（鱼护、鱼线、鱼竿）、修缮老宅（清塘、开荒、蚯蚓床）、装修小馆（鱼缸、菜牌、桌子、灶台、招牌）。
  钱主要靠傍晚开店赚，升级又让你钓得多、卖得多（见[策划大纲](docs/game-design.md)第 12 节）
...
- 菜卖完了可以"提前打烊"；打烊弹出今晚的账本：卖了什么、赚了多少、口碑到哪了

**荷花湖**

- 在"添置 · 村里的事"里捐钱修路（¥2500）以后，地图上就能去
- 鲤鱼、草鱼要慢慢遛；黑鱼、翘嘴猛冲时一定要停手；偶尔能钓到被放生的锦鲤，带回方塘养
...
- ✅ 荷花湖（修路解锁，6 种新鱼、5 道新菜）、今晚的账本、成就和外公笔记
- ✅ 新手引导（小满的便条，10 步带过第一天）；外公笔记加上菜谱页和玩法页
- ✅ 经济与升级：16 项升级（渔具、老宅、小馆），经济模拟 `npm run balance` 看每天赚多少、第几天买得起什么
